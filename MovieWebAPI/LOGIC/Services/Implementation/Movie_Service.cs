...
namespace LOGIC.Services.Implementation
{
    ...
    public class Movie_Service : IMovie_Service
    {
            ...
            try
            {
                ...
                Moviees.ForEach(s =>
                {
                    result.result_set.Add(new Movie_ResultSet
                    {
                        movie_id = s.MovieId,
                        name = s.Movie_Name,
                        releaseDate = s.Movie_ReleaseDate,
                        language =s.Language,
                    });
                });
        ...
        /// <returns></returns>
        public async Task<Generic_ResultSet<Movie_ResultSet>> AddMovie(String name, String releaseDate, String language)
        {
            Generic_ResultSet<Movie_ResultSet> result = new Generic_ResultSet<Movie_ResultSet>();
            try
            {
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public async Task<Generic_ResultSet<Movie_ResultSet>> UpdateMovie(Int64 Movie_id, String name, String releaseDate, String language)
        {
            Generic_ResultSet<Movie_ResultSet> result = new Generic_ResultSet<Movie_ResultSet>();
            try
            {
